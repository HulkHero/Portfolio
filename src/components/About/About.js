  ...
  return (
    <>
      <Box id="about" sx={{ width: "100%", wordWrap: "break-word", backgroundColor: `${theme.colors.base1}`, pt: "100px", paddingLeft: "5%px", paddingBottom: "8%" }}>
        <Grid container spacing={2} style={{ width: "90%", backgroundColor: `${theme.colors.base1}`, marginLeft: "5%" }}>
          <Grid item xs={0} sx={{ display: { xs: "none", sm: "block" } }} sm={5} md={4} >
            <Box data-aos="fade-right" ><img src={Image} style={{ height: "500px" }}></img></Box>
          </Grid>
          <Grid item xs={12} sm={7} md={8} sx={{ marginTop: "0px", paddingLeft: { xs: "4px", sm: "16" } }} >
            <Box sx={{ color: `${theme.colors.base2}`, marginLeft: { xs: "5px", sm: "100px" } }}>
              ...
              <Grid container spacing={2} direction={{ xs: 'row', sm: "column", md: 'row' }}>
                <Grid data-aos="fade-up" item xs={6} sx={{ minHeight: { md: "200px", xs: "100px" } }} ><IconsWeb icon={WebIcon} style={{ fontWeight: 200 }} type={"hellw wordsfsdfh fssj dhfg shdf gsjd"} /></Grid>
